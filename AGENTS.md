...
| `escapeHtml` + `firstName`, preheader oculto, imágenes en Cloudinary | Tal cual |
...
| Resend | 6.14 | Cliente singleton perezoso — todavía no instalado |
